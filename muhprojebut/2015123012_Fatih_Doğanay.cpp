		...
		case 1://OGRENCI MODULU 
		{
			...
			switch(secim)
			{
				case 1://ogrenci kayit ekleme 
				{
					...
					ofstream ogrEkle;
					ogrEkle.open("ogrenci.txt",ios::out | ios::in | ios::app);//dosyaya yazma islemi için gerekli satirlar
				...
				case 2://ogrenci ARAMA
				{
					...
					switch(secim)
					{
						...
						case 2://ogrenci no ya gore arama 
						{
							...
							do 
					        { 	
								ogrAraNo>>ogrNo>>ogrAdi>>ogrSoyadi>>ogrSinif>>bolum; //dosya icindeki degiskenlerin okunmasý
					            if (arananNo == ogrNo) //consalo girilen deger dosya icerisinde mevcut ise bilgiler yazdýrýlýr
								{ 
								cout<<"** OGRENCI BILGILERI **"<<endl;
								cout<<"Ogrenci No    :"<<ogrNo<<endl;
								cout<<"Ogrenci Adi   :"<<ogrAdi<<endl;
					...
					switch(secim)
					{
						case 1://SINIFA GORE LISTELEME 
						{
					        ...
					        { 
								...
								{ //gýrýlen deger eger dosya ýcerýsýnde mevcut ise tum degerler yazdýrýlýr
								cout<<"** OGRENCI BILGILERI **"<<endl;
								cout<<"Ogrenci No    :"<<ogrNo<<endl;
								cout<<"Ogrenci Adi   :"<<ogrAdi<<endl;
								cout<<"Ogrenci Soyadi:"<<ogrSoyadi<<endl;
